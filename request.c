...
int append_stats_no_terminal(char *buf, threads_stats t_stats, struct timeval arrival, struct timeval dispatch) {
...
int append_stats(char* buf, threads_stats t_stats, struct timeval arrival, struct timeval dispatch){
  int offset = append_stats_no_terminal(buf, t_stats, arrival, dispatch);
...
{
    // TODO:  should update static request stats (done)
